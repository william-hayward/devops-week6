			...
			<div className="bg-white mt-5 p-5 rounded-lg shadow-md w-full flex">
				...
				<div className="min-w-[40%] ml-3">
					...
					<div className="flex justify-between border-b-2 border-light-gray mb-6">
						...
						<h2 className="font-semibold"> 70 </h2></div>
					<div className="min-w-[40%] mb-6">
						<div className="flex justify-between border-b-2 border-light-gray">
							<h2 className="font-semibold"> Type </h2>
							<h2 className="font-semibold"> Mac Lab </h2></div>
					</div>
					<div>
						<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni, tenetur harum dolores illo quisquam quae laboriosam temporibus esse sint distinctio accusamus nemo laudantium dignissimos excepturi quas modi maxime repellendus aspernatur!</p>
					</div>
				</div>
			</div>
